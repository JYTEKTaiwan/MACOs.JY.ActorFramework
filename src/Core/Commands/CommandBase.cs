...
namespace MACOs.JY.ActorFramework.Core.Commands
{
    ...
    public class Command : CommandBase
    {
        ...
        {
            var mi = instance.GetType().GetMethod(MethodName, flags);
            if (mi == null)
            {
    ...
    public class Command<T1> : CommandBase
    {
        ...
        {
            Parameter = ValueTuple.Create<T1>(param1);

        }
        public override object Execute(IDevice instance)
        {
            var ParameterTypes = this.GetParameterTypes();
            var mi = instance.GetType().GetMethod(MethodName, flags, null, ParameterTypes, null);
            if (mi == null)
            {
    ...
    public class Command<T1, T2, T3> : CommandBase
    {
        ...
        {
            Parameter = ValueTuple.Create<T1, T2, T3>(param1, param2, param3);
